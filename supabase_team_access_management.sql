-- Coachify team access management
-- Run this entire file once in Supabase SQL Editor.
-- It lets head coaches see active assistants, cancel pending invites,
-- and remove assistant coach access from the Share Team panel.
